...
impl SyncPluginHandler<Configuration> for SqlPluginHandler {
  ...
  fn plugin_info(&mut self) -> PluginInfo {
    ...
    PluginInfo {
      ...
      help_url: "https://github.com/bartlomieju/lax-sql".to_string(),
      config_schema_url: format!("https://plugins.dprint.dev/bartlomieju/lax-sql/{}/schema.json", version),
      update_url: Some("https://plugins.dprint.dev/bartlomieju/lax-sql/latest.json".to_string()),
    }
  }
